...
class CourseServiceServicer(course_service_pb2_grpc.CourseServiceServicer):
    ...
    def GetCourse(self, request, context):
        ...
        return course_service_pb2.GetCourseResponse(course_id=request.course_id,  # Идентификатор курса из запроса
                                                    title="Автотесты API",  # Фиксированное название
                                                    description="Будем изучать написание API автотестов" #Фиксированное описание
                                                    )
